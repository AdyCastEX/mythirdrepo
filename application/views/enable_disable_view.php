...
?>
		...
		<script type="text/javascript" src = "http://localhost/mythirdrepo/jquery-1.11.0.js"></script>
		...
		<script type="text/javascript">
			...
			function activate_handler()
			{
				...
				{
					$.ajax({
						url : "http://localhost/mythirdrepo/index.php/enable_disable/activate/"+ username +"/"+ student_no + "/" + email,
						type : 'POST',
						dataType : "html",
						async : true,
			...
			function disable_handler()
			{
				...
				{
					$.ajax({
						url : "http://localhost/mythirdrepo/index.php/enable_disable/disable/"+ username +"/"+ student_no + "/" + email,
						type : 'POST',
						dataType : "html",
						async : true,
						success: function(data) {
			...
			function enable_handler()
			{
				...
				{
					$.ajax({
						url : "http://localhost/mythirdrepo/index.php/enable_disable/enable/"+ username +"/"+ student_no + "/" + email,
						type : 'POST',
						dataType : "html",
						async : true,
						success: function(data) {
